...
(function () {
  ...
  root.innerHTML =
    ...
    '<div class="rl-htext"><b>Recovery Library AI</b><span><i class="rl-dot"></i>Online · Legal research assistant</span></div>' +
    ...
    '<textarea class="rl-input" id="rl-input" rows="1" placeholder="Ask about Indian debt recovery law…" ' +
    'aria-label="Your question" autocomplete="off"></textarea>' +
    '<button class="rl-send" id="rl-send" type="submit" aria-label="Send">' +
    ICON_SEND +
    "</button>" +
    "</form>" +
    '<p class="rl-legal">Informational only · not formal legal advice. Verify against the bare statute.</p>' +
    "</div>" +
    "</div>" +
  ...
  function greet() {
    ...
    intro.innerHTML =
      ...
      "<p>Ask anything on insolvency, SARFAESI, the RDB Act, banking regulation, security interests or related commercial law in India.</p>";
    var sugs = document.createElement("div");
    sugs.className = "rl-sugs";
